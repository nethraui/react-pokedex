...
export default class PokeInfo extends Component {
    ...
    async componentDidMount(){
        const {pokeNumber} = this.props.match.params;

        //Urls for pokemon information
        const pokemonUrl = `https://pokeapi.co/api/v2/pokemon/${pokeNumber}/`;
        const pokemonSpeciesUrl = `https://pokeapi.co/api/v2/pokemon-species/${pokeNumber}/`;
        ...
        const weight = Math.round((pokeRes.data.weight * 0.220462 + 0.0001)*100)/100;
        ...
        //get all the other info like desription, ratio and rates
        axios.get(pokemonSpeciesUrl).then(res =>{
            ...
            const femaleRatio = res.data['gender_rate'];
            const genderRatioFemale  = 12.5 * femaleRatio;
            const genderRatioMale = 12.5 * (8 - femaleRatio);
